...
syn keyword objjType		void id Class SEL IMP BOOL
"syn keyword objjTypeModifier	bycopy in out inout oneway
syn keyword objjConstant	nil Nil YES NO
...
syn match  objjImport display "^\s*@import\>\s*["<]" contains=objjImported
...
" Match class names
syn match objjType "\<[A-Z][_a-zA-Z0-9]*\>"
