...
hi Cursor               guifg=NONE guibg=#849fdf
hi CursorLine           guifg=NONE guibg=#5671b0
...
hi ModeMsg              gui=bold
hi Normal               guifg=#000000 guibg=#eaeaf7
hi Pmenu                guibg=#babdb6 guifg=#555753
hi StatusLine           guifg=#666666 guibg=#eaeaea
hi Visual               guifg=NONE guibg=#d2ddf8
hi MatchParen           guifg=#ec1f75 guibg=#c0b5d2 gui=bold
